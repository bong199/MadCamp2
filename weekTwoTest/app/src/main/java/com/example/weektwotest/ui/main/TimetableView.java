...
//        stickerColors = a.getResources().getStringArray(colorsId);
        ...
        stickerColors[2] = "#a7ca70";
        stickerColors[3] = "#7dd1c1";
        stickerColors[4] = "#7aa5e9";
        stickerColors[5] = "#fbaa68";
        stickerColors[6] = "#9f86e1";
        stickerColors[7] = "#78cb87";
        stickerColors[8] = "#d397ed";

        System.out.println(stickerColors.length);
        System.out.println(stickerColors[0]);
...
//    }
    ...
    private void onCreateByBuilder(Builder builder) {
        ...
        System.out.println(builder.stickerColors.length);
