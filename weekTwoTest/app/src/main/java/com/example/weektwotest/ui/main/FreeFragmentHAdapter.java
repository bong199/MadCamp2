...
import com.example.weektwotest.ui.main.GalleryAdapter2;
...
//    private ArrayList<Post> postList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        try {
            ...
            holder.postAuthor.setText(poJsonArr.getJSONObject(position).getString("First name"));
            System.out.println("onbindvidewhodsllerf");
            System.out.println(poJsonArr.getJSONObject(position).getString("First name"));
